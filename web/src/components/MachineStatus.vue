  ...
  <div class="machine-status-container" style="margin-top: 10px;">
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <div class="status-item">
            ...
            <el-tag :type="machineStatus === '运行中' ? 'success' : 'danger'">
              {{ machineStatus }}
            </el-tag>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="status-item">
            ...
            <span class="value" :style="{ color: currentTemperature > 80 ? 'red' : 'black' }">{{ currentTemperature }}°C</span>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="status-item">
            <span class="label">菜重量：</span>
            <span class="value">{{ currentWeight }} g</span>
          </div>
        </el-col>
        <el-col :span="6">
          <div class="status-item">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <div class="status-item">
            ...
            <el-tag :type="getRobotStatusType(robotStatus)">
              {{ robotStatus }}
            </el-tag>
          </div>
        </el-col>
        <el-col :span="12">
          <div class="status-item">
            ...
            <span class="program-value">{{ currentProgram }}</span>
          </div>
        </el-col>
      </el-row>
    </el-card>
      ...
      <el-row :gutter="20">
        <el-col :span="8">
          <div class="status-item">
            ...
            <span class="value">{{ electricalBoxTemperature }}°C</span>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="status-item">
            <span class="label">电箱湿度：</span>
            <span class="value">{{ electricalBoxHumidity }}%</span>
          </div>
        </el-col>
        <el-col :span="8">
          <div class="status-item">
    ...
    <el-card class="components-card">
      ...
      <div style="display: flex; justify-content: space-between;">
        <el-table :data="inputPointsStatusLeft" style="width: 48%">
        ...
        <el-table :data="inputPointsStatusRight" style="width: 48%">
          <el-table-column prop="name" label="名称" />
          <el-table-column prop="pointName" label="点位" />
          <el-table-column prop="status" label="状态值">
            <template #default="{ row }">
    ...
    <el-card class="components-card">
      <h4>设备输出点状态</h4>
      <div style="display: flex; justify-content: space-between;">
        <el-table :data="outputPointsStatusLeft" style="width: 48%">
          <el-table-column prop="name" label="名称" />
          <el-table-column prop="pointName" label="点位" />
          <el-table-column prop="status" label="状态值">
            <template #default="{ row }">
        ...
        <el-table :data="outputPointsStatusRight" style="width: 48%">
          <el-table-column prop="name" label="名称" />
          <el-table-column prop="pointName" label="点位" />
          <el-table-column prop="status" label="状态值">
            <template #default="{ row }">
...
export default {
  ...
  methods: {
    ...
    getElectricalBoxStatus() {
      if (this.electricalBoxTemperature > 40) {
        return '过热';
      }
      if (this.electricalBoxHumidity > 90) {
        return '过潮';
      }
      return '正常';
    },
